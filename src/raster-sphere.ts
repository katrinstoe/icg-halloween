...
export default class RasterSphere {
    ...
    render(shader: Shader) {
        ...
        const aNormalColor = shader.getAttributeLocation("a_normal")
        this.gl.enableVertexAttribArray(aNormalColor)
        this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, this.indexBuffer);
        this.gl.vertexAttribPointer(aNormalColor, 3, this.gl.FLOAT, false, 0, 0)
