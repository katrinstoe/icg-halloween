...
window.addEventListener('load', () => {
    ...
    const sg = new GroupNode(new Scaling(new Vector(1, 0.2, 0.1, 0)));
    const gn1 = new GroupNode(new Translation(new Vector(1, 1, 1, 0)));
    sg.add(gn1);
    let gn2 = new GroupNode(new Translation(new Vector(0, 0, 0, 0)));
    sg.add(gn2);
    const cube = new AABoxNode(new Vector(0, 1, 1, 1));
    gn2.add(cube);
